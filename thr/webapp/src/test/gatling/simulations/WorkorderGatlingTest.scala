...
class WorkorderGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Workorder entity")
        ...
        .repeat(2) {
            ...
            .post("/api/workorders")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "plannedStart":"2020-01-01T00:00:00.000Z", "plannedEnd":"2020-01-01T00:00:00.000Z", "actualStart":"2020-01-01T00:00:00.000Z", "actualEnd":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_workorder_url")))
            .pause(10)
            .repeat(5) {
